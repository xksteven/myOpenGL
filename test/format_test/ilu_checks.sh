...
REF_IMAGES_DIR=/media/terra/workspace/graphics/myOpenGL/include/devil-1.7.99/docs/images
TESTDIR="ilu_test_$$"
if test -f $TESTDIR
then
...
sh /media/terra/workspace/graphics/myOpenGL/include/devil-1.7.99/test/format_test/generate-images.sh "$REF_IMAGES_DIR/small_stairway.jpg" "$TESTDIR" "$WINE ../bin/ilur"
...
do
	...
	$WINE ./testil -sp $TESTDIR/$image,$REF_IMAGES_DIR/$image	
